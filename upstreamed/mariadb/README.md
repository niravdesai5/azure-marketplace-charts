...
```bash
$ helm install bitnami-azure/mariadb
```
...
```bash
$ helm install --name my-release bitnami-azure/mariadb
```
...
```bash
$ helm install --name my-release -f values.yaml bitnami-azure/mariadb
```
...
```console
$ helm install --name my-release -f ./values-production.yaml bitnami-azure/mariadb
```
