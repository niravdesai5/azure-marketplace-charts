...
```console
$ helm install bitnami-azure/owncloud
```
...
```console
$ helm install --name my-release bitnami-azure/owncloud
```
...
```console
$ helm install --name my-release -f values.yaml bitnami-azure/owncloud
```
