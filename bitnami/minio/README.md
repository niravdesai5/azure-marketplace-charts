...
```console
$ helm install --name my-release -f ./values-production.yaml bitnami-azure/minio
```
...
```console
$ helm install --name my-release bitnami-azure/minio --set mode=distributed
```
...
```console
$ helm install --name my-release bitnami-azure/minio --set mode=distributed --set statefulset.replicaCount=8
```
