...
```console
$ helm repo add bitnami-azure https://marketplace.azurecr.io
$ helm install bitnami-azure/cassandra
```
...
```console
$ helm install --name my-release bitnami-azure/cassandra
```
...
```console
$ helm install --name my-release -f values.yaml bitnami-azure/cassandra
```
...
```console
$ helm install --name my-release -f ./values-production.yaml bitnami-azure/cassandra
```
...
```console
helm install --name my-release bitnami-azure/cassandra --set cluster.internodeEncryption=all \
...
helm install bitnami-azure/cassandra --set initDBConfigMap=init-db
```
