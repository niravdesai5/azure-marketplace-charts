...
$ helm install bitnami-azure/etcd --set envVarsConfigMap=etcd-env-vars
```
...
$ helm install bitnami-azure/etcd --set configFileConfigMap=etcd-conf
```
...
```console
$ helm upgrade my-release bitnami-azure/etcd \
...
```console
$ helm install --name nfs-server-provisioner bitnami-azure/nfs-server-provisioner \
...
```console
$ helm install --name new-release bitnami-azure/etcd \
