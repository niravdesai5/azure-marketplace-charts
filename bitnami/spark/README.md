...
```console
$ helm install bitnami-azure/spark
```
...
```console
$ helm install --name my-release -f values.yaml bitnami-azure/spark
```
...
```bash
$ helm install bitnami-azure/spark --set master.configurationConfigMap=configMapName
```
To set the configuration on the worker use:
```bash
$ helm install bitnami-azure/spark --set worker.configurationConfigMap=configMapName
```
...
```console
$ helm install --name my-release -f ./values-production.yaml bitnami-azure/spark
```
...
```console
$ helm install --name my-release --set ssl.enabled=true  bitnami-azure/spark
